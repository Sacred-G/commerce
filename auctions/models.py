...
class AuctionListing(models.Model):
    ...
    main_image = models.ImageField(upload_to='auction_images/', blank=True, null=True)
...
class Payment(models.Model):
    listing = models.ForeignKey(AuctionListing, on_delete=models.CASCADE, null=True)  # Add null=True
